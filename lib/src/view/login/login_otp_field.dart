...
class LoginOtpField extends StatefulWidget {
  const LoginOtpField({Key? key}) : super(key: key);

  @override
  State<LoginOtpField> createState() => _LoginOtpFieldState();
}

class _LoginOtpFieldState extends State<LoginOtpField> {
        ...
        children: [
          ...
          Material(
            ...
            child: InkWell(
              ...
              // }
await loginOTPController.loginotpController(context: context).then((value) =>  Get.to(HomeScreen()));
